<div id="mdlSharedReport" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="eventInsForm">
                    ...
                    <div class="form-group ui-widget">
                        ...
                        <input type="text" class="form-control shared-report-complete" id="shared_name" required="required"
            ...
            <div class="modal-footer">
                ...
                <button id="btnSaveSharedReport" type="button"
